<?php
/*
	Template Name: GSV Internet Daily
	*/
get_header();
	
					$args = array( 'numberposts' => 1, 'post_type' => 'gsv-internet-daily', 'orderby' => 'date', 'order' => 'DESC');
		...
		<div role="main" class="gsv-content">	
			<div class="gsv-moving-ideas-heading">
				...
				<nav class="gsv-blog-nav">
					<ul>
						...
						<li class="gsv-blog-nav-list-item gsv-blog-nav-list-item-fifth"><a href="<?php bloginfo('wpurl');?>/moving-ideas/gsv-internet-daily/" class="gsv-blog-nav-list-item-link gsv-blog-nav-list-item-link-active">GSV Internet <br /> Daily</a></li>
			...
			<div role="main" class="gsv-content-contents gsv-moving-ideas-sub-blog-contents clearfix">
				...
				<div class="gsv-moving-ideas-sub-blog-wrap">
					...
					<h1 class="gsv-moving-ideas-sub-blog-heading">Internet Daily <span class="gsv-moving-ideas-sub-blog-heading-date"><?php the_title();?></span></h1>
