...
<head>
	...
	<title>GSV Capital: <?php if(is_page('pioneers-and-mavericks')){ echo(str_replace('and', '+', get_the_title())); }else{ the_title(); } ?></title>
...
<?php 
	...
	$ipad = strpos($browser, 'ipad');
	$iphone = strpos($browser, 'iphone');
?>

<body  id="gsv-<?php echo(str_replace(' ', '-',strtolower(get_the_title()))); ?>" class="<?php if($ios !== false || $iphone !== false){?>ios-device<?php } ?>">

	<div class="gsv-container">

<div data-role="header" class="gsv-header" role="banner">

	<div class="gsv-header-contents clearfix">
					
		<a href="<?php bloginfo('siteurl');?>/" class="gsv-header-logo-link">			
				...
				<div class="gsv-header-navigation-dropdown clearfix">
					...
					<ul class="gsv-header-dropdown-navigation-list">
						...
						<li class="gsv-header-dropdown-navigation-list-item">
							...
							<ul class="gsv-header-dropdown-sub-navigation-list">
								<li class="gsv-header-dropdown-sub-navigation-list-item"><a href="<?php echo(bloginfo(siteurl)); ?>/leadership/management/" class="gsv-header-dropdown-sub-navigation-list-item-link">Management Team</a></li>
								...
								<li class="gsv-header-dropdown-sub-navigation-list-item"><a href="<?php bloginfo('siteurl');?>/about/leadership/advisory-board/" class="gsv-header-dropdown-sub-navigation-list-item-link">Advisory Board</a></li>
							</ul>
						</li>
							...
							<ul class="gsv-header-dropdown-sub-navigation-list">
								<li class="gsv-header-dropdown-sub-navigation-list-item">
									<div class="gsv-header-dropdown-sub-navigation-list-item-media-text">
										<p>Download our <a href="<?php echo(bloginfo(template_url)); ?>/assets/GSVC_CorporateBackgrounder.pdf">Corporate Backgrounder</a> (PDF).</p>
										<p>For interview requests and other media inquiries, please use our <a href="#gsv-contact-us-flyout" data-js="64i-overlay-link">contact form</a>.</p>
									</div>
								</li>
							</ul>
						</li>					
				...
				<div class="gsv-header-navigation-dropdown clearfix">
					...
					<div class="gsv-header-navigation-dropdown-our-investments">
						...
						global $post;
							...
							?>	
								<li class="gsv-header-navigation-dropdown-our-investments-list-item <?php if($portfolioCount == $numPortfolio -3){?> gsv-header-navigation-dropdown-our-investments-list-item-last-row<?php } ?>">
