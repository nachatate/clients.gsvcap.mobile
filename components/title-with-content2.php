...
$subsection_with_content_two =
array(
	"sub_section_title_two" => array(
	"name" => "sub_section_title_two",
	"std" => "",
	"title" => "Sub-Section Title",
	"description" => ""),
	"sub_section_content_two" => array(
	"name" => "sub_section_content_two",
	"std" => "",
...
function build_title_with_content_two($title){
	global $subsection_with_content_two, $post;
	
	foreach($subsection_with_content_two as $meta_box) {
		...
		if($meta_box['name'] == 'sub_section_title_two'){
		...
		}else if($meta_box['name'] == 'sub_section_content_two'){ 
...
function save_subsection_two(){ 
		
	global $subsection_with_content_two, $post, $_POST, $post_id;
	save_component($subsection_with_content_two, $post, $_POST, $post_id, plugin_basename(__FILE__));
}

/** Hook actions into WP **/
add_action('save_post', 'save_subsection_two');
